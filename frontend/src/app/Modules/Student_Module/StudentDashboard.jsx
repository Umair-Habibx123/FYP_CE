...
import ProfileSetting from "./components/ProfileSettings/StudentProfileSetting.jsx";
import AvailableProjects from "./components/AvailableProjects/AvailableProjectCards.jsx";
import SelectedProjects1 from "./components/ViewSubmissions/SelectedProjectCards.jsx";
import SelectedProjects2 from "./components/SubmitDeliverables/SelectedProjectCards.jsx";
...
import { LogOut, Sun, Moon, LayoutDashboard, FileSearch, ClipboardList, Settings, MessagesSquare, Upload, ShieldCheck, Menu, X, UserCircle2, Bot, Bell, BellDot } from "lucide-react";
...
const StudentDashboard = () => {
    ...
    const handleOptionClick = (option) => {
        ...
        localStorage.setItem("selectedOption", option); // Save to localStorage
    ...
    const TopMenuItems = [
        ...
        { label: "Available Projects", icon: <FileSearch />, key: "Available Projects" },
        { label: "Submit Project Delivables", icon: <Upload />, key: "Submit Project Delivables" },
        { label: "View Project Submissions", icon: <ClipboardList />, key: "View Project Submissions" },
        { label: "Feedback and Remarks", icon: <MessagesSquare />, key: "Feedback and Remarks" },
    ];
    ...
    const renderContent = () => {
        switch (selectedOption) {
            ...
            case "Available Projects":
                return <AvailableProjects theme={theme} />;
            case "View Project Submissions":
                return <SelectedProjects1 theme={theme} />;
            case "Submit Project Delivables":
                return <SelectedProjects2 theme={theme} />;
            case "Feedback and Remarks":
                return <SelectedProjects3 theme={theme} />;
            case "Privacy Policy":
                return <StudentPrivacyPolicy theme={theme} />;

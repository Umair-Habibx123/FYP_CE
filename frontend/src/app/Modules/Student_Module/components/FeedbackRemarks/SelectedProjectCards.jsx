...
const AvailableProjects = ({ theme }) => {
    ...
    return (
        <div className={`p-6 ${theme === "dark" ? "bg-gray-900" : "bg-gray-50"} bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg shadow-lg`}>
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-center">View Ratings/Remarks</h2>
...
// on each project click go to new page to show project ratings..
// use below api to fetch show across project id and selection id
...
import ProjectForm from "./components/PostFYP/ProjectForm.jsx";
import MyProjects from "./components/MyProjects/MyProjectCards.jsx";
...
import { LogOut, Sun, Moon, LayoutDashboard, FolderCheck, Upload, Settings, UserCheck, TrendingUp, ShieldCheck, Menu, X, UserCircle2 } from "lucide-react";
...
const IndustryDashboard = () => {
    ...
    const TopMenuItems = [
        ...
        { label: "My Submitted Project", icon: <FolderCheck />, key: "My Submitted Project" },
        { label: "Post Project Idea", icon: <Upload />, key: "Post FYP" },
        { label: "Teacher Supervision", icon: <UserCheck />, key: "Teacher Supervision" },
        { label: "Student Progress", icon: <TrendingUp />, key: "Student Progress" },
    ...
    const renderContent = () => {
        ...
        switch (selectedOption) {
            ...
            case "My Submitted Project":
                return <MyProjects theme={theme} />;
            case "Post FYP":
                return <ProjectForm theme={theme} />;
            case "Teacher Supervision":
                return <TeacherSupervision theme={theme} />;

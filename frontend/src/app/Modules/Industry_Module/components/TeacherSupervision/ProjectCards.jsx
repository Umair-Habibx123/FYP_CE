...
const TeacherSupervisionProjectCards = ({ theme }) => {
    ...
    return (
        <div className={`p-6 ${theme === "dark" ? "bg-gray-900" : "bg-gray-50"} bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg shadow-lg`}>
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-center">Approve Teacher Who Can Supervise Project In Their Universities</h2>
                    ...
                    {currentProjects.length === 0 ? (
                        ...
                        currentProjects.map((project) => (
                             <div
                                   ...
                                   onClick={() => navigate(`/teacherSupervision/${project._id}`)}
                            >
...
TeacherSupervisionProjectCards.propTypes = {
    theme: PropTypes.string.isRequired,
};

export default TeacherSupervisionProjectCards;
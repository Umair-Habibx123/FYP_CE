    ...
    const contactDetails = [
        {
            ...
            title: "Email Us",
            description: "For any inquiries, support, or collaboration opportunities, reach out at support@collaborativeedge.com. We typically respond within 24 hours.",
            highlight: "support@collaborativeedge.com"
        },
        {
            icon: <Phone className="w-6 h-6" />,
            title: "Call Us",
            description: "Speak with our support team at (123) 456-7890, Monday to Friday from 9 AM to 5 PM.",
            highlight: "(123) 456-7890"
        },
        {
            icon: <MapPin className="w-6 h-6" />,
            title: "Visit Us",
            description: "123 Collaborative Edge Lane, Education City, EC 12345. Schedule a visit to meet our team.",
            ...
            <div className="max-w-7xl mx-auto px-6 py-16 md:py-24 text-center">
                ...
                >
                    <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                        Get in Touch with <span className="text-gray-600">CollaborativeEdge</span>
                    </h1>
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                        Have questions about FYPs, partnerships, or support? Reach out via form, email, phone, or visit our office.
                    </p>
                </motion.div>
            </div>
                                ...
                                >
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600 font-medium">{item.highlight}</p>
                                        </div>
                                    </div>
                                </motion.div>
                            ))}
